...
@Component({
  selector: 'app-ver-desercion',
  templateUrl: './ver-desercion.component.html',
  styleUrls: ['./ver-desercion.component.scss']
})

export class VerDesercionComponent implements OnInit
{
